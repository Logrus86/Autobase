...
<fmt:bundle basename="i18n.text">
    <div class="btn-group" align="center" id="btn-group-admin-edit">
        ...
        <a class="btn btn-default" href='<c:url value="/do/admin-manufacturers"/>'><fmt:message key="default.manufacturers"/></a>
    </div>
</fmt:bundle>