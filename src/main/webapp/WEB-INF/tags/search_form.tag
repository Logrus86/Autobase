    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div class="input-group">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="input-group">
                                ...
                                <input type="number" min="0" max="1000" class="form-control" name="mileage" id="mileage"
                ...
                <br>
                <button type="submit" class="btn btn-primary" onclick="prepareGetRequest()"><fmt:message
                        key="default.dosearch"/></button>
            </div>
        </div>
    </div>
</form>
