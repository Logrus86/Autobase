                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#vehicle-${vehicle.id}"
                               class="collapsed">
                            ...
                            <span class="input-group-addon"><input type="checkbox" name="operable${vehicle.id}"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="input-group">
                                                ...
                                                <select class="selectpicker show-menu-arrow" data-width="auto"
                                                        name="fuelType${vehicle.id}">
                                                    <c:forEach items="${fuelTypes}" var="fuel">
                                                        <option value="${fuel}"
                                                                <c:if test="${vehicle.fuelType==fuel}">selected</c:if>>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><fmt:message
                                                        key="default.year_prod"/></span>
                                                <input type="number" class="form-control"
                                                       name="productionYear${vehicle.id}"
                                    ...
                                    <c:if test="${vehicle.type == vehicleTypes[0]}">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><fmt:message
                                                            key="default.passengerSeatsNumber"/></span>
                                                    <input type="number" class="form-control"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><fmt:message
                                                            key="default.standingPlacesNumber"/></span>
                                                    <input type="number" class="form-control"
                                                           name="standingPlacesNumber${vehicle.id}"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><fmt:message
                                                            key="default.doorsNumber"/></span>
                                                    <select class="selectpicker show-menu-arrow" data-width="auto"
                                                            name="doorsNumber${vehicle.id}">
                                                        <c:forEach var="i" begin="2" end="5">
                                                            <option
                                                                    <c:if test="${vehicle.doorsNumber==i}">selected</c:if>>${i}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="selectpicker show-menu-arrow" data-width="auto"
                                                        ...
                                                        <c:forEach var="i" begin="1" end="7">
                                                            <option
                                                                    <c:if test="${vehicle.passengerSeatsNumber==i}">selected</c:if>>${i}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
                                ...
                                <span class="input-group-addon"><input type="checkbox"
                                                                       name="withConditioner${vehicle.id}"
                                                                       <c:if test="${vehicle.withConditioner}">checked</c:if>></span>
                                                    <span class="form-control"><fmt:message
                                                            key="default.conditioner"/></span>
                                                </div>
                                            </div>
                                        </div>
                                    </c:if>
                                ...
                                <span class="input-group-addon"><input type="checkbox" name="tipper${vehicle.id}"
                                                    ...
                                                    <span class="form-control"><fmt:message
                                                            key="default.tipper"/></span>
                                                </div>
                                            </div>
                                        </div>
                                    </c:if>
                                    <button type="submit" name="vehicleId" value="${vehicle.id}"
                                            class="btn btn-primary"><fmt:message key="default.dosave"/></button>
                                </div>
                            </div>
                        </div>
                    </div>
