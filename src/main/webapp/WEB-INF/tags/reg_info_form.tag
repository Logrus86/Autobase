                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" value="${username.dob}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" value="${user.balance}  <fmt:message key="default.currency"/>" readonly>
                            </div>
                        </div>
                    </div>
                    <a class="btn btn-primary" href='<c:url value="/"/>'><fmt:message key="default.backto"/> autobase.com</a>
                </div>
            </div>
        </div>
    </form>
