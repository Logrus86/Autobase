            ...
            <c:forEach items="${manufacturerList}" var="manufacturer" varStatus="i">
                <tr>
                    <form method="post" action="change_manufacturer">
                        ...
                        <td>
                            <button class="btn btn-primary" name="save" value=${manufacturer.id} type="submit">save changes</button>
                        </td>
                        <td>
                            <button class="btn btn-danger" name="delete" value=${manufacturer.id} type="submit">delete</button>
                        </td>
                    </form>
                </tr>
            </c:forEach>
